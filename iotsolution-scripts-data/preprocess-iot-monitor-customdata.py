...
#uid is organized by the Occupation
     ...
     jsoncriteria='uid=PersonData.Occupation,filter:allrecords~\
subtopics=PersonData.PropertyName~\
values=Data.Value~\
identifiers=PersonData.PropertyName~\
...
#     preprocesslogic='dataage_1_millisecond' # millisecond,second,minute,hour,day
     ...
     preprocessconditions="PersonData.DataType=integer"
